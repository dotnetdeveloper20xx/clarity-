        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    FeeArrangement = table.Column<int>(type: "int", nullable: false),
                    EstimatedValue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FixedFeeAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    OpenedDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ClosedDate = table.Column<DateOnly>(type: "date", nullable: true),
                    LeadConsultantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Matters_Users_LeadConsultantId",
                        column: x => x.LeadConsultantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComplianceChecks_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ComplianceChecks_Matters_MatterId",
                        column: x => x.MatterId,
                        principalTable: "Matters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ComplianceChecks_Users_PerformedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatterAccesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatterAccesses_Matters_MatterId",
                        column: x => x.MatterId,
                        principalTable: "Matters",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MatterAccesses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatterNotes", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatterTasks", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatterTasks_Users_AssigneeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatterTeamMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatterTeamMembers_Matters_MatterId",
                        column: x => x.MatterId,
                        principalTable: "Matters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatterTeamMembers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingRateId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeEntries_BillingRates_BillingRateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplianceChecks_ClientId",
                table: "ComplianceChecks",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ComplianceChecks_MatterId",
                table: "ComplianceChecks",
                column: "MatterId");

            migrationBuilder.CreateIndex(
                name: "IX_ComplianceChecks_PerformedById",
                table: "ComplianceChecks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatterAccesses_MatterId_UserId",
                table: "MatterAccesses",
                columns: new[] { "MatterId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MatterAccesses_UserId",
                table: "MatterAccesses",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matters_LeadConsultantId",
                table: "Matters",
                column: "LeadConsultantId");

            migrationBuilder.CreateIndex(
                name: "IX_Matters_ReferenceNumber",
                table: "Matters",
                column: "ReferenceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Matters_Status",
                table: "Matters",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_MatterTasks_AssigneeId",
                table: "MatterTasks",
                column: "AssigneeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatterTeamMembers_MatterId_UserId",
                table: "MatterTeamMembers",
                columns: new[] { "MatterId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MatterTeamMembers_UserId",
                table: "MatterTeamMembers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_BillingRateId",
                table: "TimeEntries",
